...
% Last Modified by GUIDE v2.5 08-Mar-2020 22:38:45
...
luasp=2*(angka1*angka2+angka1*angka3+angka2*angka3);
luasp=num2str(luasp);
set(handles.text7,'string',(volume));
set(handles.text8,'string',(luasp));
